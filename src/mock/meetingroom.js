...
let meetingroomListData = Mock.mock({
  'data|8-20': [
    {
      id: '@increment',
      name: '@ctitle',
      ...
      workday_time_start: 9,
      workday_time_end: 18,
      nonworkday_time_start: 9,
      nonworkday_time_end: 18,
      capacity: '@integer(5,40)',
      tags: [],
      status: '@integer(0,1)',
      updated_at: '@datetime',
      created_at: '@datetime'
...
let database = meetingroomListData.data
...
module.exports = {
  ...
  [`GET ${apiPrefix}/meetingrooms`] (req, res) {
    const { query } = req;
  ...
  [`POST ${apiPrefix}/meetingrooms`] (req, res) {
  ...
  [`GET ${apiPrefix}/meetingrooms/:id`] (req, res) {
    const { id } = req.params
  ...
  [`DELETE ${apiPrefix}/meetingrooms/:id`] (req, res) {
    const { id } = req.params
  ...
  [`PUT ${apiPrefix}/meetingrooms/:id`] (req, res) {
    const { id } = req.params
    ...
    [`PATCH ${apiPrefix}/meetingrooms/:id`] (req, res) {
    const { id } = req.params
